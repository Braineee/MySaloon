...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Edit Saloon Style</h1>
...
<div>
    <div class="avatar avatar_round align-center">
        <label for="house_picture" style="color:#f00;">
            ...
            <img src="/storage/styles/{{ $style->picture }}" id="display_" width="200px" alt="" />
        </label>
        <br>
    </div>
    <form method="POST" action="{{ route('styles.update', [$style->id]) }}" enctype="multipart/form-data">
        @csrf
